...
export default function BottomNav({ activeTab, setActiveTab, t }) {
  ...
  // Ícones mais finos (strokeWidth={1.5}) para ar minimalista
  const Icons = {
  ...
  const NavItem = ({ id, icon, label, isMain = false }) => {
    // Lógica para ativar ícone se estiver no menu
